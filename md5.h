#ifndef _TERMINAL_CONTROL_MD5_H_
#define _TERMINAL_CONTROL_MD5_H_
...
static void md5_transform(MD5_CTX *ctx, uchar data[]) 
{  
...
static void md5_update(MD5_CTX *ctx, uchar data[], uint len) 
{  
   uint t,i;
...
static void md5_final(MD5_CTX *ctx, uchar hash[]) 
{  
   uint i;
